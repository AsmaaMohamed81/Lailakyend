...
public class Fragment_Poster_Frame2 extends Fragment implements View.OnTouchListener{
    ...
    public static Fragment_Poster_Frame2 getInstance(String user_id, String offer_id, String paper_id, int album_size, String displayImagesActivity)
    {
        Fragment_Poster_Frame2 fragment = new Fragment_Poster_Frame2();
