...
public class Fragment_Poster_Frame6 extends Fragment implements View.OnTouchListener{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.frame6,container,false);
        initView(view);
        return view;
    }
    ...
    public static Fragment_Poster_Frame6 getInstance(String user_id, String offer_id, String paper_id, int album_size, String displayImagesActivity)
    {
        Fragment_Poster_Frame6 fragment = new Fragment_Poster_Frame6();
