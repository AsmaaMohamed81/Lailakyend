...
public class Fragment_Poster_Frame16 extends Fragment implements View.OnTouchListener{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.frame16,container,false);
        initView(view);
        return view;
    }
    ...
    public static Fragment_Poster_Frame16 getInstance(String user_id, String offer_id, String paper_id, int album_size, String displayImagesActivity)
    {
        Fragment_Poster_Frame16 fragment = new Fragment_Poster_Frame16();
