...
public class FragmentDisplayCoverImage extends Fragment {
    private ImageView image1;
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view  = inflater.inflate(R.layout.fragment_display_cover_image,container,false);
        initView(view);
        return view;
    }
    ...
    public static FragmentDisplayCoverImage newInstance(GalleryImagesModel galleryImagesModel)
    {
        FragmentDisplayCoverImage fragmentDisplayTwoImage = new FragmentDisplayCoverImage();
