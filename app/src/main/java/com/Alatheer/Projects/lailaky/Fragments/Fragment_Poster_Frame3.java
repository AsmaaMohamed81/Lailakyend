...
public class Fragment_Poster_Frame3 extends Fragment implements View.OnTouchListener{
    ...
    public static Fragment_Poster_Frame3 getInstance(String user_id, String offer_id, String paper_id, int album_size, String displayImagesActivity)
    {
        Fragment_Poster_Frame3 fragment = new Fragment_Poster_Frame3();
